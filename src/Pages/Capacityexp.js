...
export default function Capacityexp() {
  return (
    <>
      <Header />
      <div className="maincontainer">
        <Row xl={2} xs={1} className="m-0 pb-100">
          ...
          <Col className="pt-xl-0 pt-4">
            ...
            <p className="fw-bolder display-5 py-3">Capacity for Expansion</p>
        ...
        <div className="m-0 pb-100">
          <div className="text-center pb-xl-5 pb-2">
          ...
          <Row xl={2} xs={1} className="m-0 pb-100">
            ...
            <Col>
              <p className="ourvision-content text-black-50 pt-xl-0 pt-4">
