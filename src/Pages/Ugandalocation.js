...
export default function Ugandalocation() {
  return (
    <>
      <Header />
      <div className="Container-spacing pb-100">
        <RB.Row xl={2} xs={1} className="pb-5">
          <RB.Col>
            <div className="brd-15">
              <img src={Ugandaimg1} className="w-100" />
            </div>
            <RB.Row className="mt-3">
              ...
              <RB.Col className="brd-15" xl={7}>
                <img src={Ugandaimg2} className="w-100" />
              </RB.Col>
            </RB.Row>
          </RB.Col>
        ...
        <section className="pb-5">
          <p className="display-5 m-0">Uganda</p>
          <div className="py-4">
            <h4 className="fw-bold"> Praveen Kumar SY </h4>
            ...
            <p className="text-secondary pt-3">
              ...
              Certus Technologies (U) Ltd IPO Box No. 5454, 1st floor ,Above
              Ruby Supermarket,Old Port Bell Road,Luzira Kampala-Uganda
            </p>
            <p className="text-secondary py-4">
              <svg
                ...
                height="20"
                fill="currentColor"
                class="bi me-2 bi-telephone-fill"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
            ...
            <p className="text-secondary ">
              <svg
                ...
                height="20"
                fill="currentColor"
                class="bi me-2 bi-envelope-fill"
                viewBox="0 0 16 16"
              >
                <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z" />
              </svg>
              praveen@cameotechedge.africa
            </p>
          </div>
        </section>
      </div>
