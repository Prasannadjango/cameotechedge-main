...
import Cyadinternationalimgcertus from "../Assets/Images/Certurus.jpg";
...
export default function Certustechnologies() {
  return (
    <>
      <Header />
      <div className="maincontainer">
        <Row xl={2} xs={1} className="m-0 pb-100">
          <Col className="vision-img pe-5">
            <img src={Cyadinternationalimgcertus} className="w-100 h-100" />
          </Col>
          <Col>
            <h4 className="Colorhead-txt">Our offices</h4>
            <p className="fw-bolder display-5 py-3">
              CERTUS TECHNOLIGES LIMITED
            </p>
          ...
          <Row className="pt-5">
            <Col xl={4}>
              <div className="d-flex flex-column setpart-card">
                ...
                <Col>
                  <Card className="setpart-cardimg">
