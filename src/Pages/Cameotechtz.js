...
import Cyadinternationalimgtz from "../Assets/Images/Cameotechtz.jpg";
      ...
      <div className="maincontainer">
        <Row xl={2} xs={1} className="m-0 pb-100">
          <Col className="vision-img pe-xl-5 pe-0">
            <img src={Cyadinternationalimgtz} className="w-100 h-100" />
          </Col>
          <Col className="pt-xl-0 pt-4">
            <h4 className="Colorhead-txt">Our offices</h4>
            <p className="fw-bolder display-5 py-3">Cameotech Tz Limited</p>
