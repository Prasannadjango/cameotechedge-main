...
import Businessmeetimg from "../Assets/Images/Businessplan.jpg";
      ...
      <div className="maincontainer">
        <Row xl={2} xs={1} className="m-0 pb-100">
          <Col className="vision-img pe-xl-5 pe-0">
            <img src={ Businessmeetimg} className="w-100 h-100" />
          </Col>
        ...
        <div className="m-0 pb-100">
          <p className="fw-bolder display-5 py-xl-5 py-3 ptext-center">
